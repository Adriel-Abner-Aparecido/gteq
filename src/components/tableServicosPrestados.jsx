                            ...
                            <tbody>
                                {
                                    servicoPrestado.map((servico, index) => (
                                        <tr key={index += 1}>
                                            ...
                                            <td className="align-middle">{servico.servicoPrestado.nomeServico}</td>
                                            <td className="align-middle">{servico.valoraReceber}</td>
                                            <td className="align-middle">{servico.valoraPagar}</td>
                                            <td className="align-middle"><Button variant="link" onClick={() => handleDelete(servico._id)}><BsTrashFill /></Button></td>
                                        </tr>
                                    )
                                    )
                                }
