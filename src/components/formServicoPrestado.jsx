...
import { Card, CardBody, Form, FormControl, FormGroup, FormLabel, Col, FormSelect, Row, Button } from "react-bootstrap"
                            ...
                            <FormSelect name="servicoPrestado" onChange={handleChange} required>
                                <option></option>
                                {
                                    servicos.map((servico, index) => (
                                        <option key={index += 1} value={servico._id}>{servico.nomeServico}</option>
                                    ))
                                }
                            </FormSelect>
                        </Col>
                        <Col xxl="auto" className="text-xxl-end p-xxl-1 ms-xxl-2">
                            <FormLabel htmlFor="valoraReceber" className="my-auto">Valor a Receber:</FormLabel>
                        </Col>
                        <Col className="p-0">
                            <FormControl className="input-number" type="number" name="valoraReceber" onChange={handleChange} required />
                        </Col>
                        <Col xxl="auto" className="text-xxl-end p-xxl-1 ms-xxl-2">
                            <FormLabel htmlFor="valoraPagar ms-xxl-2">Valor a Pagar:</FormLabel>
                        </Col>
                        <Col className="p-0">
